...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            {{-- Modal Update Foto --}}
            <div class="modal fade" id="updateFoto" tabindex="-1" aria-labelledby="updateFotoLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="updateFotoLabel">Ubah Foto Profil</h5>
            ...
            <div class="col-md-9">
                    ...
                    <form action="{{ route('profile.update') }}" method="POST">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select form-control-user @error('jk') is-invalid @enderror"
                                        name="jk">
                ...
                <div class="p-3 py-5">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="text-right">Dokumen</h4>
                    </div>
                    ...
                    <div class="row mt-2 mb-4 text-center">
                        <div class="col-md-6">
                            <img
                                src="{{ asset(auth()->user()->foto_ktp ? 'images/ktp/'. auth()->user()->foto_ktp : 'backend/assets/img/avatar/avatar-1.png') }}"
                                alt="Foto KTP" width="200px" height="300px">
                        </div>
                        <div class="col-md-6">
                            <img
                                src="{{ asset(auth()->user()->foto_kk ? 'images/kk/'. auth()->user()->foto_kk : 'backend/assets/img/avatar/avatar-1.png') }}"
                                alt="Foto KK" width="200px" height="300px">
                        </div>
                    </div>

                    <form action="{{ route('profile.dokumen') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mt-2">
                            <div class="col-md-6">
