                                            ...
                                            <div class="col">
                                                ...
                                                <div class="my-3">
                                                    ...
                                                    @elseif($item->status == 4 || $item->status == 8)
                                                        ...
                                                        @endphp
                                                        @if ($d < 0)
                                                            <span class="badge bg-danger">Masa Sewa Selesai</span>
                                                        @elseif ($d == 1)
                                                        ...
                                                        <div class="col">
                                                            <form action="{{route('update.pembayaran')}}" method="post"
                                                                ...
                                                                @if ($item->status == -2)
                                                                    ...
                                                                    <span
                                                                        style="fw-bold">Upload ulang bukti Pembayaran</span>
                                                                @else
                                                    ...
                                                    @if ($item->status < 4)
                                                        ...
                                                        @if ($item->status <= 2)
                                                            <button class="btn btn-danger delete-btn mx-2"
                                                                    title="Delete"
                                                                    value="{{$item->id}}"><i class="bi bi-trash"></i>
                                                            </button>
                                                        @elseif($item->status == -1)
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        @foreach ($item->kos->foto as $data)
                            <div class="hero mb-2"
                                 style="background-image: url('/images/kos/multiple/{{$data->nama}}')">
                            </div>
                        @endforeach
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#btnReview').click(function () {
                ...
                // bootbox prompt with multiple input (star rating and text)
                bootbox.prompt({
                    title: "Pilih Rating",
                    inputType: 'radio',
                    inputOptions: [
