                    ...
                    <tr>
                        ...
                        <td>
                            <div class="table-actions btn-group">
                                ...
                                @if ($data->status == 1)
                                    <a href="{{route('transaksi.status', [$data->id, 2])}}"
                                       class="table-action btn btn-success mr-2"
                                       data-toggle="tooltip" title="Setujui Pengajuan">
                                        <i class="fas fa-check"></i>
                                    </a>
                                    <a href="{{route('transaksi.status', [$data->id, -1])}}"
                                       class="table-action btn btn-warning mr-2"
                                ...
                                @elseif($data->status == 3)
                                    <a href="{{route('transaksi.status', [$data->id, 4])}}"
                                       class="table-action btn btn-success mr-2"
                                       data-toggle="tooltip" title="Konfimasi Pembayaran">
                                        <i class="fas fa-check"></i>
                                    </a>
